      ...
      <main className="flex-1 flex flex-col p-2 md:p-4 py-1 md:py-1 overflow-y-auto">
        <div style={{ maxWidth: '800px', margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', flex: 1, paddingTop: '1rem' }}>
          <div>
            ...
            <p style={{ ...paragraphStyle, marginTop: '1rem' }}>
              After teaching myself what I could, learning how to build and ship software, I decided to step back from the building industry to focus on this exclusively. Since then, I've worked in a breadth of different spaces, helping our government [and some enterprise] solve some of their most mission critical problems with software. I've recently brought my focus back to how we can better construct and operate our built world with technology.
            </p>
            <p style={{ ...paragraphStyle, marginTop: '1rem' }}>
