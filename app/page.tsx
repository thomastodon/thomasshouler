        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', flex: 1, paddingTop: '1rem' }}>
          <div>
            ...
            <p style={{ ...paragraphStyle, marginTop: '1rem' }}>
              For the past ten years, I’ve worked to help our government and some commercial enterprises solve some of their most mission critical problems with software. Often building from zero to one, but also scaling more mature products and teams.
            </p>
            <p style={{ ...paragraphStyle, marginTop: '1rem' }}>
